...
export const TeamMemberDialog = ({ member, open, onOpenChange }: TeamMemberDialogProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl h-[85vh] p-0 gap-0 overflow-hidden bg-card/95 backdrop-blur-xl border-[hsl(var(--coral))]/20">
        <div className="grid md:grid-cols-[300px,1fr] gap-0 h-full overflow-hidden">
          {/* Left Column - Profile Section */}
          <ScrollArea className="h-full">
            <div className="bg-gradient-to-br from-[hsl(var(--coral))]/10 via-[hsl(var(--peach))]/10 to-background p-8 flex flex-col items-center space-y-6 border-r border-border/50 min-h-full">
